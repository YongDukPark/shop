...
<section>
	<div class="container">
		...
		<div class="bbs_insert_cont_wrap">
			<form:form commandName="bean" method="post" action="write.bd">
				<input type="hidden" name="num" value=${bean.num }>
				<input type="hidden" name="pageNumber" value=${pageNumber }>
				<div class="prd_list_top">
					<div class="row">
						<div class="col-md-6">
							<h3>Q&A 작성 <%-- <span style="font-size: 13px;font-weight: 400;">(레코드 갯수:${totalCount})</span> --%></h3>
						</div>
						<div class="col-md-6">
							<!-- searchbox S -->
				...
				<div class="bbs_cont_wrap">
					<div class="bbs_title">
						<span class="title_bold input_style" style="margin-left: 0;">
							...
							<input type="text" name="subject" value="${bean.subject }" placeholder="제목" style="width: 100%;">
					...
					<div class="bbs_cont" style="padding: 15px;border-bottom: none;">
						<textarea cols="50" rows="20" name="content" placeholder="내용을 입력해주세요." style="resize: none;">${bean.content }</textarea>
