		...
		<div class="bbs_insert_cont_wrap">
			<form:form commandName="noticeBean" action="insert.nt" method="post" enctype="multipart/form-data">
				<div class="prd_list_top">
					<div class="row">
						<div class="col-md-6">
							<h3>공지사항 작성 <%-- <span style="font-size: 13px;font-weight: 400;">(레코드 갯수:${totalCount})</span> --%></h3>
						</div>
						<div class="col-md-6">
							<!-- searchbox S -->
				...
				<div class="bbs_cont_wrap">
					<div class="bbs_title">
						<span class="title_bold input_style" style="margin-left: 0;">
							...
							<input type="text" name="subject" value="${noticeBean.subject }" placeholder="제목" style="width: 100%;"/>
						</span>
					...
					<div class="bbs_cont" style="padding: 15px;border-bottom: none;">
						<textarea name="content" rows="15" cols="50" placeholder="내용을 입력해주세요.">${noticeBean.content }</textarea>
